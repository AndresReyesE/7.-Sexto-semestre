        ...
        ListSelectionListener, Runnable
{
    ...
    public void showTrainingSet(TrainingSet trainingSet)
    {
        ...
        i = 0;
        while( i < trainingSet.getTrainingSetSize())
        {
            System.out.print("Set# " + i + ": [");
            j = 0;
            while( j < trainingSet.getNumberOfInputPatterns())
            {
                System.out.print(trainingSet.inputPatterns[i][j] + "   ");
                j = j + 1;
            }//end while
            System.out.println("]");
            i = i + 1;
        ...
        while( i < trainingSet.getTrainingSetSize())
        {
            System.out.print("Set# " + i + ": [");
            j = 0;
            while( j < trainingSet.getNumberOfOutputPatterns())
            {
                System.out.print(trainingSet.outputPatterns[i][j] + "   ");
                j = j + 1;
            }//end while
            System.out.println("]");
            i = i + 1;
    ...
    public void run()
    {
        ...
        try
        {
            ...
            trainingSet.setTrainingSetSize(numberOfOutputNeurons);
    ...
    // It is called “Self-Organizing” because no supervision is required.
    char[] getSelfOrganizingMap()
    {
        ...
        while(i < view.letterListModel.size())
        {
            ...
            System.out.println("*** SAMPLE INPUT PATTERN ***");
