...
public class UDLAGeneticAlgorithm 
{
    ...
    public static Individual chukuchuku(Individual father,
    								   Individual mother) 
    {
    	Individual child;
    	int initialPosition;
        ...
        initialPosition = (int) (Math.random() *
								father.individualSize());
        finalPosition = (int) (Math.random() *
								father.individualSize());
        ...
        while(i < child.individualSize())
        {
            ...
            //end if
            	...
            	{
             		if ((i > initialPosition) || (i < finalPosition))
            			   child.setGene(i, father.getGene(i));
            		//end if
            	}//end if
            //end else
	...
	public static Population evolution()
	{
		...
		while (i < numberOfGenerations)
		{
			...
			System.out.print("Best individual of generation # " + (i+1) + "  : ");
			System.out.println(aGeneration.getFittest().fitnessValue);
			i = i + 1;
		}//end while
