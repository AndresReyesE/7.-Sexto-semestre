...
public class ProjectGeneticAlgorithms 

{
	...
	public static void presentSolution(Population lastGeneration)
	{
        ...
        System.out.println("Optimal value: " + 1 / theOptimalValue);
	}//end presentSolution
    ...
    public static void main(String[] args) 
    {
    		...
    		UDLAGeneticAlgorithm.setMutationRate(0.015);
    		...
    		UDLAGeneticAlgorithm.setTournamentSize(10);
