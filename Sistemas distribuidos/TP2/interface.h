 ...
 * exactly the way are here declared.
 ...
 * 2. Client's stub (adapter_client) will control and send the parameters specified by the client in an specific order
 ...
 * 4. Skeleton will receive these parameters in the same specific order and store them as a local reference to work with in its own address space
